...
<section>
    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark sticky-top ">
        ...
        <ul class="navbar-nav ">
            <li class="nav-item">
                <a class="nav-link" href="mujeres.php">Mujere</a>
            </li>
            <li class="nav-item">
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                <a class="nav-link" href="php/registro.php">
    ...
    <div class="container-fluid">
        <div  class="row">
            <div class="col-lg-12">
                <h1 id="productos_titulo" class="display-4 text-center">Productos para Hombres</h1>
            </div>
        </div>
        <div  class="row">
